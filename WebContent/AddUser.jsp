...
<div class="identi">
  <form action="AddUserServlet" method="Post">
    <h1 class="h3 mb-3 fw-normal">Créer votre Compte bibliothéque</h1>

    <div class="form-floating">
      <label for="floatingInput">Nom   </label><br><br>
      <input type="Text"  name="nom" class="form-control" id="floatingInput" placeholder="Nom">
    </div>
    <div class="form-floating">
      <label for="floatingInput">Prénom  </label><br><br>
      <input type="Text"  name="prenom" class="form-control" id="floatingInput" placeholder="Prenom">
    </div>
    <div class="form-floating">
      <label for="floatingInput">Login   </label><br><br>
    ...
    <div class="form-floating">
      ...
      <input type="password" name="motPass" class="form-control" id="floatingPassword" placeholder="Password">
    </div>
